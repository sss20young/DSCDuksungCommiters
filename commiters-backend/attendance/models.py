...
class User(models.Model):
    ...
    userlogin = models.CharField(max_length=45) # id
    name = models.CharField(max_length=45, blank=True, null=True) # name
    profile = models.CharField(max_length=200, blank=True, null=True) # photo
